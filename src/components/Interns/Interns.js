...
const Interns = () => {
  ...
  const internsData = {
    ...
    BUSINESS: [
      { id: 7, name: "Dean", image: `${internPhotosBase}/DEAN.png` },
      { id: 8, name: "Jerick", image: `${internPhotosBase}/JERICK.png` },
      { id: 9, name: "Justine M.", image: `${internPhotosBase}/JUSTINE.png` },
      { id: 10, name: "Diane", image: `${internPhotosBase}/DIANE.png` },
      { id: 11, name: "Vince", image: `${internPhotosBase}/VINCE.png` },
      { id: 12, name: "Adrian", image: `${internPhotosBase}/ADRIAN.png` },
    ],
    OPERATIONS: [
      {
        id: 13,
      ...
      { id: 14, name: "Hyacinth", image: `${internPhotosBase}/HYACINTH.png` },
      { id: 15, name: "Kail", image: `${internPhotosBase}/KAIL.png` },
      { id: 16, name: "Justine C.", image: `${internPhotosBase}/CLAIRE.png` },
      { id: 17, name: "Jannie", image: `${internPhotosBase}/JANNIE.png` },
      { id: 18, name: "Oliver", image: `${internPhotosBase}/JOHN.png` },
    ],
  };
              ...
              >
                <Card className={classes.card} elevation={0}>
                  ...
                  <CardContent className={classes.cardContent}>
                    ...
                    <Typography className={classes.teamLabel}>
                      {teamLabel}
                    </Typography>
                  </CardContent>
                </Card>
